...
private:
    ...
    QPointer<LdeSplashScreen> _ldeSplash;
...
public:
    ...
    auto SendMixpanelEvent(MixpanelEventKind eventKind, obs_service_t* service, SourceTreeModel* sourceTreeModel) -> void;
    auto HideLdeSplash() -> void;
...
extern bool restart;
extern bool restart_reset_settings;
