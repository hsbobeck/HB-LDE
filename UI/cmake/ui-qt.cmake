...
if(OS_WINDOWS)
  # NOTE: This is required to properly support the aws-cpp-sdk imported target(s).
  set(CMAKE_MAP_IMPORTED_CONFIG_DEBUG ${LDE_AWSCPPSDK_CONFIG})
  set(CMAKE_MAP_IMPORTED_CONFIG_RELEASE ${LDE_AWSCPPSDK_CONFIG})
  set(CMAKE_MAP_IMPORTED_CONFIG_MINSIZEREL ${LDE_AWSCPPSDK_CONFIG})
  set(CMAKE_MAP_IMPORTED_CONFIG_RELWITHDEBINFO ${LDE_AWSCPPSDK_CONFIG})
endif()

find_package(AWSSDK REQUIRED COMPONENTS s3)
target_link_libraries(obs-studio PRIVATE Qt::Widgets Qt::Svg Qt::Xml Qt::Network ${AWSSDK_LINK_LIBRARIES})
