...
class OBSBasicSettings : public QDialog {
	...
	Q_PROPERTY(QIcon advancedIcon READ GetAdvancedIcon WRITE SetAdvancedIcon
			   DESIGNABLE true)
    Q_PROPERTY(QIcon ldeVideoAudioIcon READ GetLdeVideoAudioIcon WRITE SetLdeVideoAudioIcon
               DESIGNABLE true)
    Q_PROPERTY(QIcon ldeSupportIcon READ GetLdeSupportIcon WRITE SetLdeSupportIcon
               DESIGNABLE true)
...
private:
    ...
    bool ldeVideoAudioChanged = false;
	int pageIndex = 0;
	bool loading = true;
    ...
    void LoadLdeVideoAudioSettings();
    ...
    static auto MakeProtocolKindQFromServerUrl(const QString& serverUrl) -> std::optional<ProtocolKind>;
...
private:
    ...
    void SaveLdeVideoAudioSettings();
	void SaveSettings();
	...
	QIcon advancedIcon;
    QIcon ldeVideoAudioIcon;
    QIcon ldeSupportIcon;
    ...
    QIcon GetLdeVideoAudioIcon() const;
    QIcon GetLdeSupportIcon() const;
...
private slots:
	...
	void on_baseResolution_currentIndexChanged(int index);
    void on_outputResolution_currentIndexChanged(int index);
    ...
    void SetLdeVideoAudioIcon(const QIcon &icon);
    void SetLdeSupportIcon(const QIcon &icon);
...
public:
	OBSBasicSettings(QWidget *parent, int initialPageIndex = 0);
	~OBSBasicSettings();
