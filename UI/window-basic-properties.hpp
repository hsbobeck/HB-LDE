...
private:
	...
	OBSSource source;
    bool deleteSourceOnCancel;
    bool doDeleteSource{};
    obs_sceneitem_t *deleteSourceSceneitem;
...
public:
	OBSBasicProperties(QWidget *parent, OBSSource source_, bool deleteSourceOnCancel_ = false, obs_sceneitem_t *deleteSourceSceneitem_ = nullptr);
	~OBSBasicProperties();
