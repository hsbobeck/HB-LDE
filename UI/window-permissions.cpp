	  ...
	  ui(new Ui::OBSPermissions)
{
    ...
    auto headingMargins = ui->screenRecordingHeadingLabel->contentsMargins();
    headingMargins.setBottom(5);
    //
    ui->screenRecordingHeadingLabel->setContentsMargins(headingMargins);
    ui->cameraHeadingLabel->setContentsMargins(headingMargins);
    ui->microphoneHeadingLabel->setContentsMargins(headingMargins);
    ui->accessibilityHeadingLabel->setContentsMargins(headingMargins);

    QString kDetailsLabelStylePrefix{"<p style='line-height: 125%'>"};
    QString kDetailsLabelStyleSuffix{"</p>"};
    //
    ui->descriptionLabel->setText(kDetailsLabelStylePrefix + QTStr("MacPermissions.Description") + kDetailsLabelStyleSuffix);
    ui->screenRecordingDetailsLabel->setText(kDetailsLabelStylePrefix + QTStr("MacPermissions.Item.ScreenRecording.Details") + kDetailsLabelStyleSuffix);
    ui->cameraDetailsLabel->setText(kDetailsLabelStylePrefix + QTStr("MacPermissions.Item.Camera.Details") + kDetailsLabelStyleSuffix);
    ui->microphoneDetailsLabel->setText(kDetailsLabelStylePrefix + QTStr("MacPermissions.Item.Microphone.Details") + kDetailsLabelStyleSuffix);
    ui->accessibilityDetailsLabel->setText(kDetailsLabelStylePrefix + QTStr("MacPermissions.Item.Accessibility.Details") + kDetailsLabelStyleSuffix);
    ui->openDialogLabel->setText(kDetailsLabelStylePrefix + QTStr("MacPermissions.Description.OpenDialog") + kDetailsLabelStyleSuffix);
