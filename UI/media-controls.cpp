...
void MediaControls::SetTimeVisible(bool visible)
{
    ui->timerLabel->setVisible(visible);
    ui->timerDurationSeparatorLabel->setVisible(visible);
    ui->durationLabel->setVisible(visible);
}
