...
void AutoConfigTestPage::TestBandwidthThread()
{
	...
	obs_data_set_int(vencoder_settings, "keyint_sec", 1); // NOTE: Default to 1 (originally was 2).
...
bool AutoConfigTestPage::TestSoftwareEncoding()
{
	...
	if (wiz->type != AutoConfig::Type::Recording) {
		...
		obs_data_set_string(vencoder_settings, "profile", "main"); // NOTE: Default to the "main" profile (was "high").
		obs_data_set_string(vencoder_settings, "preset", "veryfast");
	}
