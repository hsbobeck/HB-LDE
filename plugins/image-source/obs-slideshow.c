...
static void *ss_create(obs_data_t *settings, obs_source_t *source)
{
    ...
    ss->play_pause_hotkey = OBS_INVALID_HOTKEY_ID;
    ss->restart_hotkey = OBS_INVALID_HOTKEY_ID;
    ss->stop_hotkey = OBS_INVALID_HOTKEY_ID;
    ss->next_hotkey = OBS_INVALID_HOTKEY_ID;
    ss->prev_hotkey = OBS_INVALID_HOTKEY_ID;
