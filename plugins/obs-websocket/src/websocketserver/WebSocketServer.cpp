...
void WebSocketServer::onClose(websocketpp::connection_hdl hdl)
{
	...
	if (isIdentified && (conn->get_local_close_code() != websocketpp::close::status::going_away) && conf->AlertsEnabled) {
		QString title = obs_module_text("LDEWebSocket.TrayNotification.Disconnected.Title");
		QString body = QString(obs_module_text("LDEWebSocket.TrayNotification.Disconnected.Body"))
