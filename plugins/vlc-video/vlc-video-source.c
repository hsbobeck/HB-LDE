...
static void *vlcs_create(obs_data_t *settings, obs_source_t *source)
{
    ...
    c->play_pause_hotkey = OBS_INVALID_HOTKEY_ID;
    c->restart_hotkey = OBS_INVALID_HOTKEY_ID;
    c->stop_hotkey = OBS_INVALID_HOTKEY_ID;
    c->playlist_next_hotkey = OBS_INVALID_HOTKEY_ID;
    c->playlist_prev_hotkey = OBS_INVALID_HOTKEY_ID;
