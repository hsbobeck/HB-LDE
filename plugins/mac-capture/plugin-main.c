...
extern struct obs_source_info louper_virtual_audio_2ch_input_capture_info;
...
#ifdef __APPLE__
extern bool Is_LouperVirtualAudio2ch_Available();
#endif
...
#ifdef __APPLE__
    if (Is_LouperVirtualAudio2ch_Available()) {
        obs_register_source(&louper_virtual_audio_2ch_input_capture_info);
    }
#endif
